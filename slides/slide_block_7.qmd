...
**Requirements**: - All plots must share a consistent visual style (fonts, colors). - The final figure should be assembled using `grid` graphics. - The figure should be saved as a 300 DPI TIFF and a vector PDF. - The code should be clean, commented, and reproducible.
